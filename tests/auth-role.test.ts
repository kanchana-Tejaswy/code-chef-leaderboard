...
describe("Authentication & Role Authorization - 40 Permutations", () => {
  ...
  const guards = [
    ...
    { name: "requireDashboardAccess", fn: requireDashboardAccess, allowedRoles: ["ADMIN", "GK_SIR"] },
  ...
  describe("Role-based Guard Matrix (20 permutations)", () => {
    ...
    // Dashboard: ADMIN, GK_SIR. Leaderboard: ADMIN, HOD, GK_SIR, STUDENT.
    const actualAllowed = {
      requireAuthenticatedUser: ["ADMIN", "GK_SIR", "HOD", "STUDENT"],
      requireAdmin: ["ADMIN"],
      requireDashboardAccess: ["ADMIN", "GK_SIR"],
