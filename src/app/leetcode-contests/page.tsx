...
export default function LeetCodeContestsPage() {
  ...
  return (
    <div className="min-h-screen bg-brand-bg text-[#FAFAFA] font-sans antialiased p-6 md:p-12 relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-amber-600/10 blur-[120px] pointer-events-none" />
        ...
        <div className="border border-brand-border bg-brand-card/50 backdrop-blur-xl rounded-3xl p-8 shadow-2xl flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            <div className="p-3 bg-amber-500/10 border border-amber-500/20 text-amber-400 rounded-2xl shadow-inner">
              <Star className="h-8 w-8 fill-amber-400/10" />
            </div>
            <div>
              <h1 className="text-3xl font-extrabold tracking-tight text-white flex items-center gap-2">
                LeetCode Contests
                <span className="text-[10px] uppercase font-black tracking-widest px-2.5 py-0.5 rounded bg-amber-500/10 border border-amber-500/20 text-amber-300">
                  Weekly & Biweekly
                </span>
              </h1>
              <p className="text-sm text-brand-muted mt-1">
                Recent, live, and upcoming contests aggregated directly from LeetCode
              </p>
            </div>
          </div>
          <a
            ...
            className="px-5 py-2.5 rounded-2xl bg-amber-500 hover:bg-amber-600 font-bold text-xs text-black shadow-lg transition-all text-center"
          >
        ...
        {loading ? (
          ...
          <div className="border border-brand-border bg-brand-card/30 rounded-3xl p-16 text-center shadow-lg">
            ...
            <p className="text-xs text-zinc-400 mt-1 max-w-md mx-auto">
              We couldn't retrieve any LeetCode contests at the moment. Please check back later.
            </p>
          </div>
        ) : (
            ...
            {contests.map((c) => {
              ...
              return (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`block p-6 rounded-2xl border border-brand-border/40 bg-brand-card/30 hover:bg-brand-card/90 hover:border-amber-500/50 transition-all duration-200 relative overflow-hidden group ${
                ...
                >
                  ...
                  <div className="flex items-center gap-1.5 mb-3">
                    <span className="text-[8px] bg-amber-500/10 text-amber-300 border border-amber-500/20 px-2 py-0.5 rounded font-extrabold uppercase">
                      LeetCode
                    </span>
                  ...
                  <h3 className="text-sm font-black text-white group-hover:text-amber-400 transition-colors leading-tight mb-4 min-h-[2.5rem] line-clamp-2">
                    {c.name}
                  </h3>
