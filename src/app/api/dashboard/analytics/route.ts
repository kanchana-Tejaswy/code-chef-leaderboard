...
const getCachedAnalytics = async (departmentFilter?: string) => {
  return unstable_cache(
    ...
    students.forEach((s) => {
      if (s.codechefProfile && s.codechefProfile.currentRating !== null) {
    ...
    students.forEach((s) => {
      if (s.leetcodeProfile && s.leetcodeProfile.problemsSolved !== null) {
    ...
    students.forEach((s) => {
      if (s.githubProfile && s.githubProfile.openSourceScore !== null) {
